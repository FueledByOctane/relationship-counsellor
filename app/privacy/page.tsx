      ...
      <header className="px-6 py-4 border-b border-gray-200 bg-white/80 backdrop-blur-sm">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          ...
          <nav className="flex items-center gap-6">
            ...
            <Link href="/privacy" className="text-sm text-blue-600 font-medium">Privacy</Link>
        ...
        <div className="bg-white rounded-2xl shadow-sm p-8 space-y-8">
          ...
          <section>
            ...
            <div className="bg-gray-50 rounded-lg p-4 text-gray-600">
              ...
              <p className="mt-2">
                Email: <a href="mailto:privacy@meetinthefield.app" className="text-blue-600 hover:underline">privacy@meetinthefield.app</a>
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <h3 className="font-medium text-gray-900 mt-4 mb-2">3.1 Information You Provide</h3>
            <ul className="list-disc list-inside text-gray-600 space-y-1 mb-4">
              ...
              <li><strong>Communication Content:</strong> Messages exchanged during sessions with your partner</li>
              <li><strong>Payment Information:</strong> Billing details processed through our payment provider (Stripe)</li>
              <li><strong>Support Communications:</strong> Information you provide when contacting our support team</li>
            </ul>

            <h3 className="font-medium text-gray-900 mt-4 mb-2">3.2 Information Collected Automatically</h3>
            <ul className="list-disc list-inside text-gray-600 space-y-1 mb-4">
              <li><strong>Usage Data:</strong> Information about how you use our Service, including session frequency and feature usage</li>
              ...
              <li><strong>Cookies and Similar Technologies:</strong> Information collected through cookies, pixels, and similar technologies</li>
            </ul>

            <h3 className="font-medium text-gray-900 mt-4 mb-2">3.3 Special Category Data</h3>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-600 space-y-2">
              <li><strong>Contract Performance:</strong> Processing necessary to provide you with our Service and fulfil our contractual obligations</li>
          ...
          {/* How We Use Data */}
          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-3">5. How We Use Your Personal Data</h2>
            <p className="text-gray-600 leading-relaxed mb-3">
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-600 space-y-2 mb-4">
              <li><strong>Service Providers:</strong> Third-party companies that help us operate our Service, including:
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-600 space-y-1 mb-4">
              ...
              <li><strong>Conversation Data:</strong> Retained according to your preferences; you can delete at any time</li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-600 space-y-2">
              ...
              <li><strong>Right to Lodge a Complaint:</strong> Lodge a complaint with the Jersey Office of the Information Commissioner or other relevant supervisory authority</li>
            </ul>
            <p className="text-gray-600 leading-relaxed mt-4">
              To exercise any of these rights, please contact us at{' '}
              <a href="mailto:privacy@meetinthefield.app" className="text-blue-600 hover:underline">privacy@meetinthefield.app</a>.
          ...
          {/* Cookies */}
          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-3">11. Cookies and Tracking Technologies</h2>
            <p className="text-gray-600 leading-relaxed mb-3">
          ...
          <section>
            ...
            <div className="bg-gray-50 rounded-lg p-4 text-gray-600">
              ...
              <p className="mt-4 text-sm">
                ...
                <a href="https://jerseyoic.org" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
                  jerseyoic.org
                </a>
              </p>
            </div>
