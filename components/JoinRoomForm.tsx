    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <input
          ...
          maxLength={6}
          className="w-full px-4 py-3 bg-white border border-[#8B9D83]/30 rounded-xl focus:ring-2 focus:ring-[#8B9D83]/50 focus:border-[#8B9D83] outline-none transition text-[#2C2926] placeholder:text-[#6B6560]/60 uppercase tracking-widest text-center font-mono"
          disabled={isLoading}
        />
      </div>
